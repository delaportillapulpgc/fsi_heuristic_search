...
def branch_and_bound_search(problem):
    """Search the shallowest and minor pathcost nodes in the search tree first."""
    cost = graph_search(problem, PathSortedQueue(False, problem))
    return cost


def branch_and_bound_heuristic_search(problem):
    """Search the shallowest and minor pathcost nodes in the search tree first,
    with some heuristic help."""
    return graph_search(problem, PathSortedQueue(True, problem))
